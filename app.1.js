...
app.post("/", function (req, res) {
    ...
    req.on("data", function (chunk) {
        ...
        console.log(chunk + '这是chunk1');
        // <xml><ToUserName><![CDATA[gh_97b2cd0cd919]]></ToUserName>
        //     <FromUserName><![CDATA[oXCc20qxCEmeqWaOpf03jN2cHFP0]]></FromUserName>
        //     <CreateTime>1522503879</CreateTime这是chunk1>
        //     <MsgType><![CDATA[text]]></MsgType>
        //     <Content><![CDATA[5]]></Content>
        //     <MsgId>6539104368813292815</MsgId>
        // </xml>
    })
    ...
    req.on("end", function () {
        ...
        //将获取到的微信服务器发来的消息数据 使用 xml2js转成js对象 parser
        // parseString:xml2js内部的方法
        parser.parseString(result.toString(), function (err, msgObj) {
            ...
            var req = http.request({
                ...
                response.on("data", function (chunk) {
                    bufferList.push(chunk);
                    console.log(chunk+'这是chunk2');
                    // {"code":100000,"text":"3"}这是chunk2
                })
...
app.listen(801, function () {
    console.log("服务器已经启动:http://3jrg3k.natappfree.cc/")
})